...
class Transactions extends Model
{
     ...
     protected $fillable = ['client_id','invoice_id','phone','subscription_id','transaction_id','media_house_id','amount','transaction_status','payment_source','service','transact_charge'];
