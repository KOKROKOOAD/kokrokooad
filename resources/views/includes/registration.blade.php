@extends('layouts.app')
@push('styles')
    @include('includes.login-page-links')
@endpush
@section('content')

    <button class="btn btn-primary" id="business">click me</button>
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card" id="card" style="display:none;">
                    <div class="card-header">{{ __('Media house') }}</div>
...
@endsection
@section('scripts')
    @include('includes.login-page-script')
