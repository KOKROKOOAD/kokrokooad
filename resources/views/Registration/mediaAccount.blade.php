                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group{{ $errors->has('company_profile') ? ' has-error' : '' }}">
                                                ...
                                                <textarea class="form-control"   id="company_profile"  name="company_profile">{{old('company_profile')}}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group{{ $errors->has('industry_type') ? ' has-error' : '' }}">
                                                ...
                                                <input class="form-control"   id="industry_type" name="industry_type" {{old('industry_type')}}>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group{{ $errors->has('media_house') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" class="form-control" placeholder="-GTV-"  id="media_house" name="media_house" value="{{old('media_house')}}">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group{{ $errors->has('policies') ? ' has-error' : '' }}">
                                                ...
                                                <textarea class="form-control" placeholder="Share your policies"  id="policies" name="policies">{{old('policies')}}</textarea>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group {{ $errors->has('file') ? ' has-error' : '' }}">
                                                <label for="logo">Upload logo (.jpg,.jpeg,.png files:)<span class="required">*</span></label>
                                                <input type="file"    class="form-control"  id="logo" name="file" value="{{old('file')}}">
                                                @if ($errors->has('file'))
                                                    <span class="text-danger">
                                                          {{ $errors->first('file') }}
                                                        </span>
                                            ...
                                            <div class="form-group{{ $errors->has('phone1') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" class="form-control"    name="phone1" value="{{old('phone1')}}">
                                                    ...
                                                    @if ($errors->has('phone1'))
                                                        <span class="text-danger" role="alert">{{ $errors->first('phone1') }}</span>
                                                    @endif
                                            ...
                                            <div class="form-group{{ $errors->has('phone2') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" class="form-control"    name="phone2" value="{{old('phone2')}}">
                                                    ...
                                                    @if ($errors->has('phone2'))
                                                        <span class="text-danger" role="alert">{{ $errors->first('phone2') }}</span>
                                                    @endif
