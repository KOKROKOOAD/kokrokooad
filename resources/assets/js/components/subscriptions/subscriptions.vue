  ...
  <div class="page-wrapper full-calender animated fadeIn">
    ...
    <div class="page-header">
      <div class="row align-items-end">
        ...
        <div class="col-lg-4">
          <div class="page-header-breadcrumb" v-show="show_calendar">
    ...
    <div class="page-body">
      <div class="card animated fadeIn" v-show="show_calendar">
        <div class="card-header">
          <h5>
            Segment Calender
            <small>Click to view subscription details.</small>
          </h5>
          <div class="row">
            <div class="col-md-5"></div>
            <div class="col-md-">
              <p class="text-danger" v-show="del">
                <img src="/images/loading.gif" style="height: 20px;width: 20px;" />
                <strong>Deleting please wait.....</strong>
              </p>
            </div>
            <div class="col-md-5"></div>
          </div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <span
              class="float-right" style="padding-left: 50px;"
            ...
            <span
                    class="float-right"
                    v-show=" config.subs.status == 'in cart' && checkSubDate(config.subs.start) == false" style="padding-left: 50px;"
            >
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group btn-group-sm">
                        ...
                        <button
                          @click="confirmPayment(config.subs.subscription_id)"
                          data-toggle="tooltip"
                        ...
                        <button
                          data-toggle="tooltip"
                          @click="deleteSub(config.subs.subscription_id)"
...
export default {
  ...
  methods: {
      ...
      sweetAlert(
        ...
        function(isConfirm) {
          ...
          if (isConfirm) {
            ...
            formData.append(
              "endDate",
              event.start.format("YYYY-MM-DD ") + event.end.format("h:mm")
            );
    ...
    eventRender: function(event, element, view) {
      element
        .find(".fc-time")
        .after('<span class="glyphicon glyphicon-time"></span><br> ');
      if (event.status === "pending") {
        element
          .find(".fc-title")
          .after(
            "<br><span class='text-info fa fa-comment' style='font-weight: bolder'> " +
              event.status +
              "</span>"
          );
        ...
        element
          .find(".fc-title")
          .after(
            "<br><span class='fa fa-shopping-cart' style='font-weight: bolder;color: darkred'> " +
              event.status +
              "</span>"
          );
        ...
        element
          .find(".fc-title")
          .after(
            "<br><span class=' fa fa-comment' style='font-weight: bolder;color: darkred'> " +
              event.status +
              "</span>"
          );
        ...
        element
          .find(".fc-title")
          .after(
            "<br><span class=' fa fa-comment' style='font-weight: bolder;color: #ffffff '> " +
              event.status +
              "</span>"
          );
        ...
        element
          .find(".fc-title")
          .after(
            "<br><span class=' fa fa-comment' style='font-weight: bolder;color: green;'> " +
              event.status +
              "</span>"
          );
        ...
        element
          .find(".fc-title")
          .after(
            "<br><span class='text-success fa fa-comment' style='font-weight: bolder;color: greenyellow'> " +
              event.status +
              "</span>"
          );
        ...
        element
          .find(".fc-title")
          .after(
            "<br><span class='text-success fa fa-comment' style='font-weight: bolder'> " +
              event.status +
              "</span>"
          );
        ...
        element
          .find(".fc-title")
          .after(
            "<br><span class='text-danger fa fa-comment' style='font-weight: bolder'> " +
              event.status +
              "</span>"
          );
        ...
        element
          .find(".fc-title")
          .after(
            "<br><span class=' fa fa-comment' style='font-weight: bolder;color: #0f3e68'> " +
              event.status +
              "</span>"
          );
      }
