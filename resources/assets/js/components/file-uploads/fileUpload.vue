                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <input  type="file" name="files" id="filer_input1" ref="file" accept=".xlsx,.xls,.pdf,.odt,.docx,.mp3,.wav,.jpeg,.png,.jpg,.mp4,.mkv" v-on:change="onFileChange($event)">
                            ...
                            <div style="padding-top: 16px;">
                                ...
                                <router-link :to="{name:select_rate_card, params: {'durat': file_dura },query: { debug: true }}" v-show="valid_file" role="button" type="button" class="btn btn-mat btn-info animated fadeIn" >Next</router-link>
    ...
    export default {
        ...
        data(){
            return{
                ...
                tv_ext : ["xlsx","xls","pdf","odt","docx","mp3","wav","mp4","avi","jpeg","png","jpg","mkv"],
            ...
            onFileChange(e) {
                ...
                if (this.getSelectMedia === 'TV') {
                    if (this.tv_ext.includes(this.ext)) {
                        ...
                        store.dispatch('getFileSize', this.file_size);
                        this.valid_file = true;
                        if(this.getSelectMedia == 'TV' && this.video_ext.includes(this.ext)){
